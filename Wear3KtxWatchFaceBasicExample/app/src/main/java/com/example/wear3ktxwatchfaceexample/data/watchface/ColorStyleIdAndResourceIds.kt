...
private const val AMBIENT_COLOR_STYLE_ICON_ID = R.drawable.white_style // needed drawable-280dpi, hdpi and mdpi
...
enum class ColorStyleIdAndResourceIds(
    ...
    companion object {
        ...
        fun toOptionList(context: Context): List<UserStyleSetting.ListUserStyleSetting.ListOption> {
            ...
            Log.v(TAG, "toOptionsList: $colorStyleIdAndResourceIdsList")
